class Admin::ClassesController < Admin::BaseController
  ...
  def create
    ...
    if @pilates_class.save
      redirect_to admin_classes_path, notice: "Clase creada exitosamente"
    else
  ...
  def update
    if @pilates_class.update(pilates_class_params)
      redirect_to admin_classes_path, notice: "Clase actualizada exitosamente"
    else
  ...
  def destroy
    ...
    redirect_to admin_classes_path, notice: "Clase eliminada exitosamente"
  end
