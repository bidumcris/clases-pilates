...
ActiveRecord::Schema[8.0].define(version: 2026_02_17_223209) do
  ...
  create_table "credits", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "room_id"
    t.index ["room_id"], name: "index_credits_on_room_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "weekly_days", default: [], null: false, array: true
    ...
    t.index ["weekly_days"], name: "index_users_on_weekly_days"
    t.index ["whatsapp_opt_in"], name: "index_users_on_whatsapp_opt_in"
    t.index ["whatsapp_opt_in_at"], name: "index_users_on_whatsapp_opt_in_at"
  end

  add_foreign_key "credits", "rooms"
